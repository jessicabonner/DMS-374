					...
					<div class="row">
						<div class="column small-12">
							<div class="topnav">
								...
								<a href="DMS_change_password.php" style="position:absolute;left:-40px;top:-12px;color:white;" onclick="w3_close()"><font size="2">Change Password</font></a>
								<a href="DMS_logout.php" style="position:absolute;left:-20px;top:-12px;color:white;" onclick="w3_close()"><font size="2">Logout</font></a>
