		...
		<div class="nav-overlay" id="nav-overlay"></div>
			...
			<div class="w3-main" style="margin-left:40px;margin-right:450px">
				...
				<div class="w3-container" id="showcase">
					...
					<!-- Secondary Text -->
					<hr style="align:left;width:800px;border:5px solid #BF5700" class="w3-round">
					<br>
					...
					<body>
						<form name="apply_form" action = "ADMIN_create_program_functionality.php" method= "post">
							...
							<table>
								...
								<!--text box for doctor eid-->
								<tr>
									<td><p>Doctor EID</p></td>
								</tr>
								<tr>
									<td><input type="text" name="doctor_EID" size="64" maxlength="10" required/></td>
								</tr>
