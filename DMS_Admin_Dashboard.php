...
id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
		<a href="DMS_CreateProgram.html" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Create New Program</a>
		<a href="DMS_CreateApplication.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Create New Application</a>
	</div>
</nav>
