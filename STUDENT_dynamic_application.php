    ...
    <div class="nav-wrapper" role="navigation">
      ...
      <div class="container container-nav container-nav-phase2">
        ...
        <a href="STUDENT_dashboard.php?user_id= <?php echo $user_id ?>" onclick="w3_close()" class="nav-link has-child nolink">Home</a>
                ...
                <li class="nav-item" role="menuitem">
        <a href="STUDENT_edit_profile_information.php?user_id= <?php echo $user_id ?>" onclick="w3_close()" class="nav-link has-child nolink">Edit Profile</a>
				<div class="sub-nav-wrapper">
          </div>
              </li>
                <li class="nav-item" role="menuitem">
        <a href="STUDENT_create_student_information.php?user_id= <?php echo $user_id ?>" onclick="w3_close()" class="nav-link has-child nolink">New Application</a>
				<div class="sub-nav-wrapper">
          </div>
              </li>
                <li class="nav-item" role="menuitem">
